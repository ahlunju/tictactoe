angular.module('app.inventory-turnover').controller('inventoryTurnoverDayController',['$scope', '$filter', 'uiGridConstants', 'inventoryTurnoverReportServices', '$controller', function ($scope,  $filter, uiGridConstants, ReportServices, $controller){
